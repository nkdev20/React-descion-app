...
var Person = function () {
    function Person() {
        var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
...
var me = new Student('test', 24, 'computer science');
var trvel1 = new Traveller('test', 24, 'xyz');
console.log(trvel1.getGreeting());
console.log(me.getGreeting());
console.log(me.getDescription());
var other = new Student('test', 24);
